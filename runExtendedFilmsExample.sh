...
java $JVM_ARGS -jar bin/ShExML-v0.5.1.jar -nu -m=mapping-rules/films_extended.shexml -o=data/films_extended.ttl
...
java $JVM_ARGS -jar bin/ShExML-v0.5.1.jar -m=mapping-rules/films_extended.shexml -s -o=generated-shapes/shexml-shex-films-extended.shex
java $JVM_ARGS -jar bin/ShExML-v0.5.1.jar -m=mapping-rules/films_extended.shexml -sh -o=generated-shapes/shexml-shacl-films-extended.ttl
